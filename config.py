...
FINANCIAL_VLM_PRIMARY_ID = MULTIMODAL_LLM_ID
FINANCIAL_VLM_SECONDARY_ID = MULTIMODAL_LLM_ID
...
# Extraction & Reconciliation parameters (Stage 3)
FINANCIAL_PAGE_MAX_WORKERS = 4
FINANCIAL_REQUEST_MAX_ATTEMPTS = 3
FINANCIAL_RETRY_DELAY_SECONDS = 2.0

# Multi-DPI, Non-Deterministic Ensemble Extraction Parameters
FINANCIAL_DPI_LEVELS = [150, 200, 300]
FINANCIAL_EXTRACTION_PASS_COUNT = 3
FINANCIAL_VLM_TEMPERATURE_MIN = 0.15
FINANCIAL_VLM_TEMPERATURE_MAX = 0.55
